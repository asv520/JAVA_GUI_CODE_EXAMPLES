...
public class Label_Practice {
    ...
    public static void main(String[] args) {
        ...
        ImageIcon image = new ImageIcon("coding.jpg");
        Border border = BorderFactory.createLineBorder(Color.green,3);

        JLabel label = new JLabel(); //create a label
        label.setText("Coding is fun"); //set text of label
        label.setIcon(image);
        ...
        //label.setBounds(100, 100, 250, 250); //set x,y position within frame as well as dimensions(label gets fixed)
        ...
        frame.add(label);
        frame.pack();//This will resize the size of the frame to fit all the components within the label
    }
}
